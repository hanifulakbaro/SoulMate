        ...
        <div className="flex gap-5 max-md:flex-col" style={{marginTop: "-40px"}}>
          ...
          <div className="relative w-[56%] max-md:w-full">
            <img
              ...
              className="object-contain w-full aspect-[0.78] max-md:mt-10 ml-[-30px]"
            />
            <div className="absolute top-[180px] left-[45px] right-5 text-white text-lg font-bold leading-tight z-10 text-center"
            style={{fontSize: "17px"}}>
              {Array.isArray(music) && music.length > 0 ? (
                music.map((m, i) => (
                  <div key={i}>
          ...
          <div className="relative w-[44%] max-md:w-full ml-5">
            <img
              ...
              style={{width: "400px"}}
            />
            <div className="absolute top-[200px] left-[125px] w-[300px] text-white text-lg font-bold leading-tight z-10 text-center">
              {Array.isArray(movie) && movie.length > 0 ? (
                movie.map((m, i) => (
